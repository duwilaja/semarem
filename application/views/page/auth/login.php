      ...
      <div class="row">
        ...
        <div class="col-xl-5 p-0">
          <div class="login-card">
            <div>
              <div><a class="logo text-start" href="#"><img class="img-fluid for-light" src="<?=base_url();?>/my/img/logo.png" alt="looginpage" style="width: 150px; margin-left:150px;"><img class="img-fluid for-dark" src="<?=base_url();?>template/cuba/assets/images/logo/logo_dark.png" alt="looginpage"></a></div>
