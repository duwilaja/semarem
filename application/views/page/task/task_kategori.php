    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="" method="post" id="form_add">
          <div class="mb-3">
            <label for="Kategori" class="form-label">Task Kategori</label>
            <input type="text" class="form-control" name="task_kategori" placeholder="">
          </div>
        </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="" method="post" id="form_edit">
          ...
          <div class="mb-3">
            <label for="Kategori" class="form-label">Task Kategori</label>
            <input type="text" class="form-control" id="kategori" name="task_kategori" placeholder="">
          </div>
        </div>
        <div class="modal-footer">
          <button class="btn btn-primary" type="button" data-bs-dismiss="modal">Close</button>
