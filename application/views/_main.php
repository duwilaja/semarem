...
<html lang="id">
  <head>
    ...
    <!-- ico-font-->
    <link rel="stylesheet" type="text/css" href="<?=$template;?>assets/css/vendors/icofont.css">
    <!-- Themify icon-->
    <link rel="stylesheet" type="text/css" href="<?=$template;?>assets/css/vendors/themify.css">
    <!-- Flag icon-->
    <link rel="stylesheet" type="text/css" href="<?=$template;?>assets/css/vendors/flag-icon.css">
    <!-- Feather icon-->
  ...
  <body>
            ...
            <ul class="nav-menus">
              ...
              <li class="cart-nav onhover-dropdown">
                ...
                <ul class="cart-dropdown onhover-show-div">
                  ...
                  <li class="mt-0">
                    <div class="media"><img class="img-fluid rounded-circle me-3 img-60" src="<?=$template;?>assets/images/ecommerce/01.jpg" alt="">
                  ...
                  <li class="mt-0">
                    <div class="media"><img class="img-fluid rounded-circle me-3 img-60" src="<?=$template;?>assets/images/ecommerce/03.jpg" alt="">
                      <div class="media-body"><span>V-Neck Shawl Collar Woman's Solid T-Shirt</span>
                        <p>Yellow(#fcb102)</p>
                        <div class="qty-box">
                          <div class="input-group"><span class="input-group-prepend">
    ...
    <!-- scrollbar js-->
    <script src="<?=$template;?>assets/js/scrollbar/simplebar.js"></script>
    <script src="<?=$template;?>assets/js/scrollbar/custom.js"></script>
    <!-- Sidebar jquery-->
