...
function modal_add() {
    ...
    $('#instansi_id').html(`<option value="">--Pilih Instansi--</option>`);
 ...
 function modal_edit(id)
{
    ...
    $('#einstansi_id').html(`<option value="">--Pilih Instansi--</option>`);
    ...
    setTimeout(() => {
        $.ajax({
            type: "GET",
            url: "../backend/Api_unit/get?id="+id,
            dataType: "json",
            success: function (v) {
                $('#einstansi_id').val(v[0].instansi_id);
                $('#unit').val(v[0].unit);

                $('#einstansi_id').select2({
                    dropdownParent: $('#edit')
                });
            }
        });
